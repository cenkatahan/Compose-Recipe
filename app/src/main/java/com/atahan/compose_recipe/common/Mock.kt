...
object Mock {
    fun fetchMockMeals() = listOf(
        ...
        Recipe(
            1,
            "Hamburger",
            arrayListOf("Cook meat and patty. Put ingredients."),
            true,
            Category.FAST_FOOD,
            arrayListOf(
                "Egg",
        ...
        Recipe(
            2,
            "Pizza",
            arrayListOf("Put ingredients on dough. Cook in the oven"),
            false,
            Category.FAST_FOOD,
            arrayListOf(
                "Egg",
